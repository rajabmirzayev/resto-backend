# RestoFlow Entity Specification

> Fayl yolu: `restoflow-back/resto-entities.md`
...
|---|---|---|---|---|
| 1 | `common-jpa` | — | `CoreEntity`, `SoftDeletableCoreEntity`, enums, types, DTOs | `az.flowix.common.*` |
| 2 | `auth-gateway` | `/api/auth-ms/auth/` | `RefreshToken` | `az.flowix.auth.entity` |
...
**Package:** `az.flowix.common.entity`
...
```java
package az.flowix.common.exception.handling.dto;

import az.flowix.common.exception.handling.error.CommonErrorCode;
import lombok.AllArgsConstructor;
import lombok.Builder;
import lombok.Getter;
import lombok.NoArgsConstructor;

import static az.flowix.common.exception.handling.utils.Constant.DEFAULT_SUCCESS_MESSAGE;
...
**Package:** `az.flowix.common.constant`
...
> Package: `az.flowix.table.entity`
...
import az.flowix.common.type.TableReservation;
import jakarta.persistence.Column;
import jakarta.persistence.Entity;
import jakarta.persistence.EnumType;
import jakarta.persistence.Enumerated;
...
import az.flowix.common.entity.CoreEntity;
